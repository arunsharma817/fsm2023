...
const [searchProduct , setSearchProduct] = useState("");
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      ...
      const getProducts = await axios.get('http://localhost:5000/api/products/list', {
        method: 'GET',
        headers: {
          "Content-Type": "application/json",
          "consultant-token": authToken
  ...
  if (productId) {
    ...
    return (
      <div className="container my-3">
        <input type="text" name="searchbox" value = {searchProduct} placeholder='Search Here' onChange={(e) => inputEvent(e)}/>
