...
const AddManufacturers = (props) => {
    ...
    const handleSubmit = (e) => {
	   ...
	   if(formValues.manufacturer_account_details.length > 50) {
        newErrors.manufacturer_account_details = "Manufacturer Account  must  be less than 20 characters";
       }
	   ...
	   if(!formValues.manufacturer_number_of_employees) {
           newErrors.manufacturer_cancelled_cheque = "Cancelled Cheque is required";
       }else if(formValues.manufacturer_number_of_employees.length > 7) {
        newErrors.manufacturer_number_of_employees = "Number of Employees  be less than 20 characters";
       }
	   
	   if(!formValues.manufacturer_director_fname) {
           newErrors.manufacturer_director_fname = "Director First Name is required";
       }else if(formValues.manufacturer_director_fname.length > 200) {
        newErrors.manufacturer_director_fname = "First Name  be less than 20 characters";
       }
	   
	   if(!formValues.manufacturer_director_lname) {
           newErrors.manufacturer_director_lname = "Director First Name is required";
       }else if(formValues.manufacturer_director_lname.length > 200) {
        newErrors.manufacturer_director_lname = "Last Name  be less than 200 characters";
       }
       ...
       }else if(formValues.manufacturer_director_mobile.length > 200) {
        newErrors.manufacturer_director_mobile = "Director Mobile  be less than 200 characters";
       }
	   
	   if(formValues.manufacturer_director_linkedin.length > 500) {
        newErrors.manufacturer_director_linkedin = "Director Linedin  be less than 200 characters";
       }
	   
	   if(formValues.manufacturer_director_reviews.length > 500) {
        newErrors.manufacturer_customer_reviews = "Customer Reviews  be less than 200 characters";
       }
	   
	   if(formValues.manufacturer_customer_rating.length > 5) {
        newErrors.manufacturer_customer_rating = "Customer Rating  be less than 200 characters";
       }
	   
	   if(formValues.manufacturer_facebook_url.length > 500) {
        newErrors.manufacturer_facebook_url = "Facebook URL must be less than 500 characters";
       }
	   
	   if(formValues.manufacturer_instagram_url.length > 500) {
        newErrors.manufacturer_instagram_url = "Instagram URL must be less than 500 characters";
       }
	   
	   if(formValues.manufacturer_linkedin_url.length > 500) {
        newErrors.manufacturer_linkedin_url = "LinkedIn URL must be less than 500 characters";
       }
	   
	   if(formValues.manufacturer_youtube_url.length > 500) {
        newErrors.manufacturer_youtube_url = "Youtube URL must be less than 500 characters";
       }
	   if(!formValues.manufacturer_director_mobile) {
           newErrors.manufacturer_director_mobile = "Director Mobile Name is required";
       }else 
	   if(formValues.manufacturer_made_in_countries.length > 500) {
        newErrors.manufacturer_made_in_countries = "Instagram URL must be less than 500 characters";
       }
	   
	   if(formValues.manufacturer_attributes.length > 500) {
        newErrors.manufacturer_attributes = "LinkedIn URL must be less than 500 characters";
       }
	   
	   if(formValues.manufacturer_brief_history.length > 500) {
        newErrors.manufacturer_brief_history = "Youtube URL must be less than 500 characters";
       }
