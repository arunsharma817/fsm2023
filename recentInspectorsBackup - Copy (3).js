...
router.post('/create', fetchowner, [
    ...
    console.log("I am create Api of Inspector");
    try {
        ...
        const { inspector_name, inspector_email, inspector_password , inspector_consultant_id } = req.body;

        const salt = await bcrypt.genSalt(10);
        const secPass = await bcrypt.hash(req.body.inspector_password, salt);

        const inspector = new Inspectors({ inspector_name, inspector_email, inspector_password, inspector_consultant_id: inspector_consultant_id });
