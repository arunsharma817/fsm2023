                                            ...
                                            <div className="col-12">
                                                    ...
                                                    <div className="col-12 col-md-6 form-group">     
                                                        ...
                                                        <div className="col-12 col-md-6 form-group">
                                                            ...
                                                            <select className="col-12 col-md-6 form-group" name="manufacturer_industry" id="manufacturer_industry" value={formValues.manufacturer_industry} onChange={(e) => handleInputChange(e)}>
														...
														<div className="col-12 col-md-6 form-group">
                                                            <label>Corporate Certificate :</label>
                                                                <input className="col-12 col-md-6 form-group" type="file"  accept=".pdf,.doc,.docx" name="manufacturer_corporation_certificate" id="manufacturer_corporation_certificate" value={formValues.manufacturer_corporation_certificate} onChange={(e) => handleInputChange(e)} />
