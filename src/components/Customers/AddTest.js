                                            ...
                                            <div className="col-12">
                                                    ...
                                                    <div className="col-12 col-md-6 form-group">     
                                                        ...
                                                        <div className="col-12 col-md-6 form-group">
                                                            ...
                                                            <select className="col-12 col-md-6 form-group" name="customer_industry" id="customer_industry" value={formValues.customer_industry} onChange={(e) => handleInputChange(e)}>
														...
														<div className="col-12 col-md-6 form-group">
                                                            <label>Corporate Certificate :</label>
                                                                <input className="col-12 col-md-6 form-group" type="file"  accept=".pdf,.doc,.docx" name="customer_corporation_certificate" id="customer_corporation_certificate" value={formValues.customer_corporation_certificate} onChange={(e) => handleInputChange(e)} />
