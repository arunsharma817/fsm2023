...
const ConsultantsState = (props) => {
    ...
    const [consultants, setConsultants] = useState(consultantsInitial)
    
    return(
        <ConsultantsContext.Provider value={{ consultants , setConsultants }}>
            {props.children}
...
export default ConsultantsState;